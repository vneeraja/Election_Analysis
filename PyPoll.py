...
for candidate_name in candidate_votes:
        ...
        #candidate_election_results = (f"{candidate_name} : recieved {percentage_votes:.1f}% ({votes})\n")
        candidate_election_results = (f"{candidate_name}: {percentage_votes:.1f}% ({votes:,})\n")
        #write the results to the text file
        with open(file_to_save, "a") as txt_file:
            txt_file.write(candidate_election_results)
...
winning_candidate_summary = (
    ...
    f"-------------------------\n")
#write the winning candidate summary to the text file
with open(file_to_save, "a") as txt_file:
